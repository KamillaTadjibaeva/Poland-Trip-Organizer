...
#                                                         #
#  Demonstrates: API integration, error handling,         #
#  wrapper functions, and defensive programming           #
#  Uses Wikidata SPARQL API (free, no key required)       #
#  to fetch live city data for Poland                     #
#---------------------------------------------------------#


# ==========================================================================
# Wikidata API: Fetch Polish Cities Data
# ==========================================================================
...
')
  ...
  # ---- Handle connection failure -> fall back to built-in ----
  if (is.null(response)) {
  ...
  # Pre-allocate vectors (as taught in purrr/efficiency class)
  n <- length(bindings)
